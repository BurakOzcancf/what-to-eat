            ...
            <Router>
                <div className="grid lg:grid-cols-4 grid-cols-2 gap-2 justify-center h-96 p-5 text-white text-lg">
                    <Link
                        ...
                        <div className='h-full bg-gradient-to-t from-gray-700 rounded-xl to-transparent flex justify-center items-end hover:transition-all hover:opacity-0 pb-2'>Home</div>
                    </Link>
                    <Link
                        ...
                        <div className='h-full bg-gradient-to-t from-gray-700 rounded-xl to-transparent flex justify-center items-end hover:transition-all pb-2 hover:opacity-0'>Vegetarian</div>
                    </Link>
                    <Link
                        ...
                        <div className='h-full bg-gradient-to-t from-gray-700 rounded-xl to-transparent flex justify-center items-end hover:transition-all pb-2 hover:opacity-0'>Vegan</div>
                    </Link>
                    <Link
                        ...
                        <div className='h-full bg-gradient-to-t from-gray-700 rounded-xl to-transparent flex justify-center items-end hover:transition-all pb-2 hover:opacity-0'>Dessert</div>
                    </Link>
                </div>
                <Routes>
                  <Route
